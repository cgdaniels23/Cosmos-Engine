...
description: Write follow up emails, set up follow up sequences, and track who's hot, who's warm, and who's going cold. Built for founders and small teams who can't afford to let leads slip through the cracks.
argument-hint: [e.g. "help me follow up with these 12 leads from my webinar" or "write a follow up email to a prospect who hasn't replied" or "my leads are going cold"]
---
...
### Phase 1: Ingestion
*Note on Interactivity: Give a quick first pass based on what the user said, THEN refine with questions. Never make someone answer 4 questions before getting ANY value. If they say 'I got 12 leads from my webinar,' immediately draft a rough sequence outline, THEN ask clarifying questions to refine it.*
...
4 leads are going cold. Here's the one nudge that could save them.

## Cross-Skill Chain
After pipeline setup, recommend daily-focus: "Pipeline set up — want to add these follow-ups to your daily priorities? Try Daily Focus."

## Share This
After drafting sequences, offer: "Want to share these follow-up templates with your sales team?" Format as a clean doc.
