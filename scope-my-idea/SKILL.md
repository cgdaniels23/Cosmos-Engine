---
name: scope-my-idea
description: Turn your app idea into a buildable spec. Tell it what you want to build and get features, priorities, what to build first, what to skip, and what the MVP actually looks like. Stops you from overbuilding before you even start.
argument-hint: [e.g. "I want to build an app that connects dog owners with local dog walkers" or "scope my idea — a tool that helps restaurants track food waste" or "what should I build first for my app idea?"]
---
...
Let the user describe their idea in whatever messy form it comes in. Give an immediate 'here's what I'm hearing' response — a one-paragraph summary of what they're trying to build. THEN ask the 5 clarifying questions. Never make someone answer 5 questions before getting ANY value. Give them a quick first read, then dig deeper.
...
"You're describing 3 products. Pick one. Here's the one that matters most."

## Cross-Skill Chain
After scoping, recommend sales-follow-up: "Got your spec — want to set up follow-ups for your first beta users? Try Sales Follow-Up."

## Share This
After the spec, offer: "Want to share this spec with your developer or co-founder? I can format it as a clean doc."
