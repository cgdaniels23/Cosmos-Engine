---
name: meeting-notes
description: Turn meeting chaos into clear action. Paste your meeting notes or transcript and get decisions, action items with owners and deadlines, open questions, and what was actually decided. No more "wait, what did we agree on?"
argument-hint: [e.g. "what did we decide? [paste meeting notes]" or "summarize this meeting and extract action items [paste transcript]" or "clean up my meeting notes"]
---
...
### Phase 5: Action and Proactive Offer
After the extraction, proactively offer to act: "Want me to create task records for these 5 action items? Want me to draft a recap email to the team? Want me to set reminders for the deadlines?" Don't just dump the output and stop — offer next actions.
...
Sarah has 6 action items and no one was assigned the biggest one.

## Cross-Skill Chain
After extraction, recommend daily-focus: "Want to track these action items in your daily check-in? Try Daily Focus."

## Share This
After extraction, offer: "Want to send a recap email to the team? I can draft it from these notes."
