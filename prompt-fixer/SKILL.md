---
name: prompt-fixer
description: Turn a fuzzy AI request into a clear one that actually gets you somewhere. Paste what you were about to ask ChatGPT, Claude, or any AI tool, and this skill rewrites it into a cleaner, more structured prompt so the response is clearer, safer, and more useful. No prompt engineering required.
argument-hint: [e.g. "help me make my website better and maybe improve the words and code" or paste any messy prompt you were about to send to an AI]
---
...
### Phase 1: Accept the Messy Prompt
...
### Phase 2: Diagnose
Figure out what's wrong — silently, don't lecture them about it. Common issues:
